...
export const dictionary = {
  fr: {
    ...
    pricing: {
      ...
      subtitle:
        "Aucun frais initial. Commencez avec un aperçu gratuit, puis un seul abonnement mensuel qui inclut tout, sans engagement.",
      plans: [
        {
          name: "Aperçu Gratuit",
          price: "0 $",
        ...
        },
        {
          ...
          tag: "POPULAIRE",
          description:
            "Un site professionnel complet, sans aucun frais initial. Tout est inclus dans un seul abonnement mensuel.",
          features: [
            "Site web professionnel complet",
            "Hébergement rapide et sécurisé",
            "Sécurité et sauvegardes automatiques",
            "Mises à jour du design et du contenu",
        ...
        },
        {
          ...
          tag: "",
          description:
            "Une vision précise ou des besoins qui sortent de l'ordinaire ? Tout ce qui est inclus dans Pro, plus un design et des fonctionnalités sur mesure.",
          features: [
            "Tout ce qui est inclus dans Site Pro",
            "Design entièrement sur mesure",
            "Fonctionnalités avancées et personnalisées",
            "Intégrations (API, CRM, réservation, etc.)",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "Non. Vous pouvez commencer avec un aperçu gratuit, sans carte de crédit. Vous ne payez l'abonnement mensuel que si vous décidez de continuer.",
        },
        {
        ...
        },
        {
          ...
          a: "Rien à gérer de votre côté. Avec l'abonnement Site Pro, nous nous occupons de l'hébergement, de la sécurité, des sauvegardes et des mises à jour mensuelles pour que vous n'ayez jamais à y penser.",
        },
        {
          q: "Y a-t-il un contrat à long terme ?",
          a: "Non. L'abonnement est reconduit mois par mois. Vous pouvez annuler à tout moment, sans frais ni pénalité. Nous gagnons votre confiance chaque mois.",
        },
      ],
    },
    showcase: {
  ...
  en: {
    ...
    pricing: {
      ...
      subtitle:
        "No upfront cost. Start with a free preview, then one simple monthly subscription that includes everything, no commitment.",
      plans: [
        {
          name: "Free Preview",
          price: "$0",
        ...
        },
        {
          ...
          tag: "POPULAR",
          description:
            "A complete professional website with no upfront cost. Everything is included in one monthly subscription.",
          features: [
        ...
        },
        {
          ...
          tag: "",
          description:
            "A precise vision or needs beyond the ordinary? Everything in Pro, plus custom design and advanced features.",
          features: [
            "Everything included in Pro Site",
            "Fully custom design",
            "Advanced, personalized features",
            "Integrations (API, CRM, booking, etc.)",
            "Dedicated support",
          ],
          cta: "Contact us",
        },
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "No. You can start with a free preview, no credit card required. You only pay the monthly subscription if you decide to continue.",
        },
        {
        ...
        },
        {
          ...
          a: "Nothing for you to manage. With the Pro Site subscription, we handle hosting, security, backups, and monthly updates so you never have to think about them.",
        },
        {
          q: "Is there a long-term contract?",
          a: "No. The subscription renews month by month. You can cancel at any time, with no fees or penalties. We earn your trust every month.",
        },
      ],
    },
    showcase: {
