...
export const dictionary = {
  fr: {
    ...
    pricing: {
      ...
      subtitle:
        "Un paiement unique pour un site web professionnel complet. Aucun frais mensuel, aucun abonnement. Ce que vous voyez est ce que vous payez.",
      plans: [
        {
          name: "Aperçu Gratuit",
          price: "0 $",
          cadence: "",
          tag: "SANS CARTE DE CRÉDIT",
          description:
            "Pas prêt à payer pour un nouveau site ? On vous comprend. Recevez un aperçu complet de votre futur site en 24 heures, sans engagement.",
          features: [
            "Aperçu complet de votre site en 24 heures",
            "Basé sur ce que vous avez déjà",
            "Aucune carte de crédit requise",
            "Aucun engagement",
          ],
          cta: "Réservez votre aperçu gratuit",
        },
        {
          ...
          tag: "PAIEMENT UNIQUE",
          description:
            "Un site professionnel complet et sur mesure pour un seul paiement. Aucun frais mensuel, aucun abonnement, aucune surprise.",
          features: [
            "Site web professionnel complet et sur mesure",
            "Hébergement rapide et sécurisé inclus",
            "Sécurité et sauvegardes automatiques",
            "Optimisé pour mobile et pour Google",
            "Le site vous appartient à 100 %",
            "Paiement unique. Aucun frais mensuel, jamais.",
          ],
      ...
      items: [
        {
          ...
          a: "Un paiement unique de 2 000 $ pour un site professionnel complet. Aucun frais mensuel, aucun abonnement. Vous pouvez d'abord recevoir un aperçu gratuit avant de payer quoi que ce soit.",
        },
        {
          q: "Dois-je payer d'avance ?",
          a: "Vous commencez avec un aperçu gratuit, sans carte de crédit. Vous ne payez le montant unique de 2 000 $ que lorsque vous êtes entièrement satisfait du résultat.",
        },
        {
          q: "Combien de temps faut-il pour construire mon site web ?",
          a: "Vous recevez un premier aperçu de votre site en 24 heures, et votre site complet est généralement en ligne en moins d'une semaine. Pas d'attente interminable.",
        },
        {
        ...
        },
        {
          ...
          a: "Rien à gérer de votre côté. L'hébergement, la sécurité et les sauvegardes sont inclus, et votre site vous appartient à 100 %. Aucun frais mensuel, jamais.",
        },
        {
          q: "Y a-t-il un contrat à long terme ?",
          a: "Non. Il n'y a aucun contrat ni abonnement. Vous payez une seule fois, et le site est à vous. C'est tout.",
        },
      ],
    },
    showcase: {
    ...
    about: {
      ...
      solutionCard1Value: "0 $",
      solutionCard1Label: "Aujourd'hui",
      solutionCard1Desc: "Aucun frais initial. Vous commencez sans rien payer.",
      ...
      solutionCard3Value: "2 000 $",
      solutionCard3Label: "Une seule fois",
      solutionCard3Desc: "Paiement unique. Site complet, hébergement et sécurité inclus. Aucun frais mensuel.",
      ...
      comparisonRows: [
        { traditional: "5 000 $ - 10 000 $", us: "2 000 $ une seule fois" },
        { traditional: "Frais mensuels récurrents", us: "Aucun frais mensuel, jamais" },
  ...
  en: {
    ...
    pricing: {
      ...
      subtitle:
        "A single payment for a complete professional website. No monthly fees, no subscription. What you see is what you pay.",
      plans: [
        {
          name: "Free Preview",
          price: "$0",
          ...
          tag: "NO CREDIT CARD",
          description:
            "Not ready to pay for a new site? We get it. Get a complete preview of your future website in 24 hours, no commitment.",
          features: [
            "Complete preview of your site in 24 hours",
            "Based on what you already have",
            "No credit card required",
            "No commitment",
          ],
          cta: "Book your free preview",
        },
        {
          ...
          description:
            "A complete, custom professional website for a single payment. No monthly fees, no subscription, no surprises.",
          features: [
            "Complete, custom professional website",
            "Fast, secure hosting included",
            "Security and automatic backups",
            "Optimized for mobile and Google",
      ...
      items: [
        {
          ...
          a: "A single payment of $2,000 for a complete professional website. No monthly fees, no subscription. You can get a free preview first, before paying anything.",
        },
        {
          q: "Do I have to pay upfront?",
          a: "You start with a free preview, no credit card required. You only pay the one-time $2,000 once you're fully happy with the result.",
        },
        {
          q: "How long does it take to build my website?",
          a: "You get a first preview of your site in 24 hours, and your complete site is usually live in less than a week. No endless waiting.",
        },
        {
        ...
        },
        {
          ...
          a: "Nothing for you to manage. Hosting, security, and backups are included, and your site is 100% yours. No monthly fees, ever.",
        },
        {
          q: "Is there a long-term contract?",
          a: "No. There is no contract or subscription. You pay once, and the site is yours. That's it.",
        },
      ],
    },
    showcase: {
    ...
    about: {
      ...
      solutionCard1Value: "$0",
      solutionCard1Label: "Today",
      solutionCard1Desc: "No upfront cost. You start without paying anything.",
      solutionCard2Value: "24h",
      solutionCard2Label: "Preview",
      solutionCard2Desc: "A complete preview of your website in 24 hours, no commitment.",
      solutionCard3Value: "$2,000",
      solutionCard3Label: "One time",
      solutionCard3Desc: "One-time payment. Complete site, hosting, and security included. No monthly fees.",
      comparisonTitle: "The traditional approach vs. Our approach",
      comparisonColTraditional: "Traditional Agency",
      comparisonColVs: "VS",
      comparisonColUs: "ÉquipeSitePRO",
      comparisonRows: [
        { traditional: "$5,000 - $10,000", us: "$2,000 one-time" },
        { traditional: "Recurring monthly fees", us: "No monthly fees, ever" },
